...
$\frac{\partial L_{contant}}{\partial F^{l}\_{ij}} = \begin{equation} \begin{cases}(F^l-P^l)& \test{F^l_{ij}>0} \\ 0& \test{F^l_{ij}<0}\end{cases} \end{equation}$
...
$$\frac{\partial E_l}{\partial F^l_{ij}}= \begin{cases} \frac{1}{4N^{l^2}M^{l^2}}(F^{l^T}(G^l-A^l))\_{ji}& \test{F^l_{ij}>0} \\ 0& \test{F^l_{ij}<0} \end{cases} $$
